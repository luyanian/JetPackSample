...
public final class RegexUtils {
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isESMobile(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_MOBILE_SIMPLE, input);
    }
    ...
    public static String getSecurityPhoneNum(String phoneNum){
        return  phoneNum.replaceAll("(\\d{3})\\d{4}(\\d{4})", "$1****$2");
    }
    public static String getSecurityEmail(String email){
